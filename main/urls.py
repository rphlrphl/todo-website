...
urlpatterns = [
    ...
    path('task/<str:task_id>/delete/', views.delete_task, name='delete-task'),
    path('team/<int:team_id>/bulk-delete-acc/', views.bulk_delete_accomplished, name='bulk-delete-acc'),
]
